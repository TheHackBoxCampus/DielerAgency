...
const Benefits = (): RN => {
  return (
    <div className="w-full xs:hidden xl:flex h-28 text-black bg-white flex justify-around items-center mt-5 rounded-xl">
...
const Guarantee = (): RN => {
  return (
    <div id="benefits" className="w-full xs:hidden xl:flex justify-between gap-2">
...
const TextThatConverts = (): RN => {
  return (
    <div className="mt-5 bg-yellow-primary text-center p-2 rounded-tr-xl rounded-tl-xl flex gap-1 justify-center items-center">
      <img src="/icons/play-video.svg" alt="icon" />
      <span className="text-black font-bold xs:text-[11px] lg:text-md xl:text-xl">
...
const VideoMain = () => {
  return (
    <div className="w-full sm:h-[200px] 2xl:h-[623px] flex justify-center items-center bg-gray-400 rounded-bl-xl rounded-br-xl">
...
const SalesVideo = (): RN => {
  return (
    <section className="sm:w-full 2xl:w-[90%] m-auto flex flex-col justify-center">
      <Guarantee />
